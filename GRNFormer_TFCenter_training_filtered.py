...
import DatasetMaker.DatasetwithTFcenterfiltered as dt
...
class GRNFormerLinkPred(pl.LightningModule):
    def __init__(self, learning_rate=1e-4,node_dim=NODES_DIM,out_chan=OUT_CH,num_heads=NUM_HEADS,edge_dim=EDGE_DIM,encoder_layers=ENCODE_LAYERS, **model_kwargs):
        ...
        self.criterian = nn.SoftMarginLoss()
    ...
    def forward(self, exp_data,bert_data,edge_sampled,edge_attr):
        ...
        edge_prob =self.edgepred(grnnodes_lat,grnedges_lat[0])
...
def train_GRNFormerLinkPred():
    ...
    gene_expression_file = '/home/aghktb/GRN/GRNformer/Data/sc-RNA-seq/hHep/Filtered--ExpressionData.csv'
    ...
    regulation_file = '/home/aghktb/GRN/GRNformer/Data/sc-RNA-seq/hHep/Filtered--network1.csv'
