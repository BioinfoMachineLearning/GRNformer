...
class GRNFormerLinkPred(pl.LightningModule):
    ...
    def training_step(self,batch,batch_idx):
        ...
        metrics = self.train_metrics(grn_pred_edge.view(-1),batch_exp_data.squeeze(0).view(-1),prefix="train")
    ...
    def validation_step(self,batch,batch_idx):
        ...
        metrics = self.valid_metrics(grn_pred_edge.view(-1),batch_exp_data.squeeze(0).view(-1),prefix="valid")
...
def train_GRNFormerLinkPred():
    ...
    for i in range(0,5):
        ...
        split_indices = torch.load(split_ind[i])
