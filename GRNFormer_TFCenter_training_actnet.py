...
ENCODE_LAYERS = 3
OUT_CH=16
DATASET_DIR = "/home/aghktb/GRNformer"
...
def train_GRNFormerLinkPred():
    ...
    root = '/home/aghktb/GRNformer/Data/sc-RNA-seq/hHep'
    gene_expression_file = '/home/aghktb/GRNformer/Data/sc-RNA-seq/hHep/ExpressionData.csv'
    tf_genes = pd.read_csv("/home/aghktb/GRNformer/Data/sc-RNA-seq/hHep/TFHumans.csv",header=None)[0].to_list()
    # replace with actual TF gene names
    regulation_file = '/home/aghktb/GRNformer/Data/sc-RNA-seq/hHep/HepG2-ChIP-seq-network.csv'
    ...
    split_indices = torch.load("/home/aghktb/GRNformer/Data/sc-RNA-seq/hHep/dataset_splits.pt")
